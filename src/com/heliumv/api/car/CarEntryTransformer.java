...
public class CarEntryTransformer extends BaseFLRTransformer<CarEntry> {
	
	@Override
	public CarEntry transformOne(Object[] flrObject, 
		...
		entry.setNumberPlate((String) flrObject[2]);
		return entry ;
	}
}
